            ...
            <div className="w-full bg-base-200 shadow-xl m-auto">
                <div className="card-body w-5/6 m-auto">
                    ...
                    <div className="flex flex-col sm:flex-row sm:flex-wrap sm:justify-around">
                        <Project imgPreview={ecommerce} name="E-commerce Back-end" repoLink="https://github.com/KrystopherQ/crispy-doodle" />
                        ...
                        <Project imgPreview={teamGen} name="Team Generator" repoLink="https://github.com/KrystopherQ/TPG-numbero1"/>
